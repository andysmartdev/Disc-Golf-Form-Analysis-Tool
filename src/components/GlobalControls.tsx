    ...
    <div className={`global-controls${isCollapsed ? ' global-controls--collapsed' : ''}`}>
      ...
      <div className="global-controls__row">
        ...
        {eitherPlaying ? (
          ...
          >
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{verticalAlign: "middle"}}><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg> Pause
          </button>
        ) : (
          <button
          ...
          >
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{verticalAlign: "middle"}}><polygon points="6,4 20,12 6,20"/></svg> Play
          </button>
        )}
