    ...
    <div className="video-panel">
      ...
      {!drawing.enabled && <div className="video-panel__controls">
        ...
        <div className="controls-row">
          ...
          >
            {isPlaying
              ? <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>
              : <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><polygon points="6,4 20,12 6,20"/></svg>
            }
          </button>
          ...
          >
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><rect x="4" y="4" width="3" height="16"/><polygon points="9,12 20,4 20,20"/></svg>
          </button>
